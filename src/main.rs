            ...
            (
                ...
                Enemy {
                    direction: Vec2::new(
                        rand::random::<f32>(),
                        rand::random::<f32>(),
                    ).normalize(),  // Normalize the direction to make it a unit vector
                },
            )
        );
    }
...
pub fn update_enemy_direction(
    ...
    for (transform, mut enemy) in enemy_query.iter_mut() {
        ...
        if direction_changed {
            let sound_effect_1 = asset_server.load("/home/selene/bevy_tutorials/bevy_ball_game/assets/audio/pluck_001.ogg");
            let sound_effect_2 = asset_server.load("/home/selene/bevy_tutorials/bevy_ball_game/assets/audio/pluck_002.ogg");
